...
public class OperationClaimConfiguration : IEntityTypeConfiguration<OperationClaim>
{
    ...
    private HashSet<OperationClaim> getSeeds()
    {
        ...
        #region BannedPrompts
        
        seeds.Add(new OperationClaim { Id = ++id, Name = "BannedPrompts.Admin" });
        
        seeds.Add(new OperationClaim { Id = ++id, Name = "BannedPrompts.Read" });
        seeds.Add(new OperationClaim { Id = ++id, Name = "BannedPrompts.Write" });
        
        seeds.Add(new OperationClaim { Id = ++id, Name = "BannedPrompts.Add" });
        seeds.Add(new OperationClaim { Id = ++id, Name = "BannedPrompts.Update" });
        seeds.Add(new OperationClaim { Id = ++id, Name = "BannedPrompts.Delete" });
